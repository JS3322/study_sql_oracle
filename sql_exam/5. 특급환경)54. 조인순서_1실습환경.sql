...
DROP TABLE SYSTEM.T_CUST54;
CREATE TABLE SYSTEM.T_CUST54
(  CUST_NO       VARCHAR2(6)
    , CUST_NM      VARCHAR2(50)
...
CREATE PUBLIC SYNONYM T_CUST54 FOR SYSTEM.T_CUST54;
...
CREATE INDEX SYSTEM.IX_T_CUST54_01 ON SYSTEM.T_CUST54(CUST_TYPE);


DROP TABLE SYSTEM.T_HOBBY54;
CREATE TABLE SYSTEM.T_HOBBY54
(  CUST_NO        VARCHAR2(6)
...
CREATE PUBLIC SYNONYM T_HOBBY54 FOR SYSTEM.T_HOBBY54;
...
DROP TABLE SYSTEM.T_ORDER54;
CREATE TABLE SYSTEM.T_ORDER54
( ORDER_NO     VARCHAR2(7)
    , CUST_NO      VARCHAR2(6)
    , ORDER_DT     VARCHAR2(8)
...
CREATE PUBLIC SYNONYM T_ORDER54 FOR SYSTEM.T_ORDER54;
...
CREATE INDEX SYSTEM.IX_T_ORDER54_01 ON SYSTEM.T_ORDER54(CUST_NO);

EXECUTE DBMS_STATS.GATHER_TABLE_STATS('SYSTEM', 'T_CUST54');
EXECUTE DBMS_STATS.GATHER_TABLE_STATS('SYSTEM', 'T_HOBBY54');
EXECUTE DBMS_STATS.GATHER_TABLE_STATS('SYSTEM', 'T_ORDER54');
