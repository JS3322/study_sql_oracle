...
drop table system.t_주문14;

create table system.t_주문14 AS
...
/*
 동의어 생성 : system.t_주문14 = t_주문14
 */
create public synonym t_주문14 for system.t_주문14;

CREATE INDEX system.IX_t_주문14_01 ON system.t_주문14(주문지역코드, 주문일자, 주문금액);

EXECUTE DBMS_STATS.GATHER_TABLE_STATS('system', 't_주문14');
